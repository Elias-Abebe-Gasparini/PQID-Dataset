...
- `code_lines >= 5`
- `gate_count >= 2`
- `retrieval_strategy != "empirical_promoted_repo"`: `False`
...
- Cleaned core benchmark candidates: `734` (0.8%)
- Cleaned Tier 2 entries: `90,985` (99.2%)
...
- `empirical_promoted_repo`: `52,707`
- `search`: `17,133`
